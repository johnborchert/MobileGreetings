...
- (id) init {
    ...
    //self = [super initWithFrame:CGRectMake(0.0, 0.0, 150.0, 150.0)];  // original code
	if (self) {
		
		self.backgroundColor = [UIColor colorWithWhite:0.0 alpha:.7];
        //self.backgroundColor = [UIColor blueColor];  // original code
		self.layer.cornerRadius = 5.0;
		
		lblDisplay = [[UILabel alloc] initWithFrame:CGRectMake(0.0, 0.0, 100.0, 100.0)];
        //lblDisplay = [[UILabel alloc] initWithFrame:CGRectMake(0.0, 0.0, 150.0, 150.0)];   // original code
        ...
        //lblDisplay.font = [UIFont fontWithName:@"Helvetica-Bold" size:16.0];   // original code
...
- (id) initWeb {
	//self = [super initWithFrame:CGRectMake(0.0, 0.0, 100.0, 100.0)];   // original code
    self = [super initWithFrame:CGRectMake(0.0, 0.0, 50.0, 50.0)];
	if (self) {
		
		//self.backgroundColor = [UIColor colorWithWhite:0.0 alpha:.7];  // original code
		self.layer.cornerRadius = 5.0;
